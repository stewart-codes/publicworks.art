...
export const WorkPgSchema = new EntitySchema<WorkPg>({
  ...
  columns: {
    ...
    hidden: { type: 'boolean', name: 'hidden', nullable: false, default: false },
    ...
    publishStatus: { type: 'smallint', name: 'publish_status', nullable: false, default: 0 },
    description: { type: 'text', name: 'description', nullable: false, default: '' },
    descriptionAdditional: { type: 'text', name: 'description_additional', nullable: true },
    blurb: { type: 'text', name: 'blurb', nullable: false, default: '' },
    startDate: { type: 'timestamptz', name: 'start_date', nullable: false },
    resolution: { type: 'varchar', name: 'resolution', nullable: false, default: '1080:1080' },
    selector: { type: 'varchar', name: 'selector', nullable: false, default: 'canvas' },
    license: { type: 'varchar', name: 'license', nullable: true },
    externalLink: { type: 'varchar', name: 'external_link', nullable: true },
    pixelRatio: { type: 'smallint', name: 'pixel_ratio', nullable: false, default: 1 },
    maxTokens: { type: 'int', name: 'max_tokens', nullable: false },
    priceStars: { type: 'int', name: 'price_stars', nullable: false, default: 50 },
    royaltyPercent: { type: 'smallint', name: 'royalty_percent', nullable: false, default: 5 },
    royaltyAddress: { type: 'varchar', name: 'royalty_address', nullable: true },
    sg721CodeId: { type: 'int', name: 'sg721_code_id', nullable: true },
    minterCodeId: { type: 'int', name: 'minter_code_id', nullable: true },
    isDutchAuction: { type: 'boolean', name: 'is_dutch_auction', nullable: false, default: false },
    dutchAuctionEndDate: { type: 'timestamptz', name: 'dutch_auction_end_date', nullable: true },
  ...
  indices: [
    { columns: ['chainId', 'ownerId', 'startDate', 'id'], name: 'idx_works_chain_owner' },
    {
      columns: ['chainId', 'hidden', 'publishStatus', 'startDate', 'id'],
      name: 'idx_works_chain_published',
    },
    { columns: ['chainId', 'hidden', 'startDate', 'id'], name: 'idx_works_chain_hidden_all' },
    { columns: ['chainId', 'publishStatus', 'startDate', 'id'], name: 'idx_works_chain_visible' },
